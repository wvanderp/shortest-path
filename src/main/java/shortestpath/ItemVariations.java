...
public enum ItemVariations {
    ...
    SLASH_WEAPON(
        ...
        // Other slash weapons with alleast +1 slash bonus
        ItemID.BH_VESTAS_LONGSWORD,
        ItemID.VESTAS_LONGSWORD_BH,
        ItemID.THUNDER_KHOPESH,
        ItemID.ZOMBIE_AXE,
        ItemID.BLADE_OF_SAELDOR_INFINITE_IORWERTH,
        ItemID.BLADE_OF_SAELDOR_INFINITE_TRAHAEARN,
        ItemID.BLADE_OF_SAELDOR_INFINITE_CADARN,
        ItemID.BLADE_OF_SAELDOR_INFINITE_CRWYS,
        ItemID.BLADE_OF_SAELDOR_INFINITE_MEILYR,
        ItemID.BLADE_OF_SAELDOR_INFINITE_AMLODD,
        ItemID.BLADE_OF_SAELDOR_INFINITE_ITHELL,
        ItemID.ABYSSAL_TENTACLE,
        ItemID.LEAGUE_3_WHIP_TENTACLE,
        ItemID.ABYSSAL_WHIP,
        ItemID.ABYSSAL_WHIP_ICE,
        ItemID.ABYSSAL_WHIP_LAVA,
        ItemID.LEAGUE_3_WHIP,
        ItemID.VOIDWAKER,
        ItemID.DEADMAN_VOIDWAKER,
        ItemID.OSMUMTENS_FANG,
        ItemID.OSMUMTENS_FANG_ORNAMENT,
        ItemID.BH_DRAGON_LONGSWORD_IMBUE,
        ...
        ItemID.BH_DRAGON_BATTLEAXE_CORRUPTED,
        ItemID.EMBERLIGHT,
        ItemID.ARKAN_BLADE,
        ...
        ItemID.BH_DRAGON_SCIMITAR_CORRUPTED,
        ItemID.ZAMORAK_HASTA,
        ItemID.GRANITE_LONGSWORD,
        ItemID.DRAGONHUNTER_LANCE,
        ItemID.LEAFBLADED_SWORD,
        ItemID.BRUT_DRAGON_SPEAR,
        ItemID.DRAGON_SHORTSWORD,
        ItemID.GHRAZI_RAPIER,
        ItemID.GHRAZI_RAPIER_OR,
        ItemID.BH_DRAGON_SHORTSWORD_CORRUPTED,
        ItemID.RUNE_BATTLEAXE,
        ItemID.TZHAAR_KNIFE,
        ItemID.RUNE_LONGSWORD,
        ItemID.OLAF2_BRINE_SABRE,
        ItemID.HUNDRED_CLEAVER,
        ...
        ItemID.FEVER_CUTLASS_UNLUCKY_JENKINS_LUCKY_CUTLASS,
        ...
        ItemID.DARKLIGHT,
        ItemID.MACHETTE_REDTOPAZ,
        ItemID.ARCLIGHT_INACTIVE,
        ItemID.STEEL_SCIMITAR,
        ItemID.WESTERN_BANNER_MEDIUM,
        ItemID.STEEL_LONGSWORD,
        ItemID.FALADIAN_SWORD,
        ItemID.SILVERLIGHT,
        ItemID.FEVER_CUTLASS_BRASSHAND_HARRY,
        ItemID.BRUT_STEEL_SPEAR,
        ItemID.MITHRIL_AXE,
        ItemID.ANMA_AXE,
        ItemID.RUNE_DAGGER,
        ItemID.HUNDRED_KNIFE,
