...
public class Transport {
    ...
    @Getter
    private int origin = WorldPointUtil.UNDEFINED;

    /** The ending point of this transport */
    @Getter
    private int destination = WorldPointUtil.UNDEFINED;
    ...
    /**
     * Any varbits to check for the transport to be valid. All must pass for a
